<?php /*a:2:{s:82:"/www/wwwroot/yiwunqianbaonew/application/mobile/view/digitalassets/wallet_out.html";i:1535790768;s:62:"/www/wwwroot/yiwunqianbaonew/application/mobile/view/base.html";i:1535011708;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	...
	<div class="header">
	    ...
	    <div class="header_c"><h2><?php echo lang("易宝转出"); ?></h2></div>
          ...
          if(i<6){
              ...
              if (i==6) {
                  setTimeout(function(){
                      ...
                      $.ajax({
                          url:'/mobile/Digitalassets/wallet_out',
                          type:'post',
