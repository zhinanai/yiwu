<?php /*a:2:{s:74:"/www/wwwroot/yiwunqianbaonew/application/mobile/view/growth/buycenter.html";i:1535680616;s:62:"/www/wwwroot/yiwunqianbaonew/application/mobile/view/base.html";i:1535011708;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="big_width100">
    <div class="trade_choose flex">
        <a href="" class="choosed"><?php echo lang('买入'); ?></a>
        <a href="<?php echo url('/mobile/Trading/selldets'); ?>"><?php echo lang('卖出'); ?></a>
    </div>
    <div class="choose_title">
        <h4><?php echo lang('请选择对应数量买入'); ?></h4>
    </div>
...
<div class="sell_tab flex">
    <a href="<?php echo url('/mobile/Growth/purchase'); ?>"><?php echo lang('创建订单'); ?></a>
    <a href="<?php echo url('/mobile/Growth/buyrecords'); ?>"><?php echo lang('买入记录'); ?></a>
    <div  class="myorder">
        <span><?php echo lang('我的买单'); ?></span>
        <div class="order_box">
            <div class="order_list">
                <a href="<?php echo url('/mobile/Growth/nofinsh'); ?>"><?php echo lang('未完成订单'); ?></a>
                <a href="<?php echo url('/mobile/Growth/conpay'); ?>"><?php echo lang('提交打款'); ?></a>
                <a href="<?php echo url('/mobile/Growth/dofinsh'); ?>"><?php echo lang('已完成订单'); ?></a>
            </div>
...
<div class="ftc_wzsf">
    <div class="srzfmm_box">
        <div class="qsrzfmm_bt clear_wl">
            ...
            <span class="fl"><?php echo lang('请输入支付密码'); ?></span>
        </div>
    ...
    <div class="numb_box">
        <div class="xiaq_tb">
            <img src="/static/mobile/images/jftc_14.jpg" height="10">
        </div>
        <ul class="nub_ggg">
            <li>
            ...
            <li>
                <a href="javascript:void(0);" class="zf_empty"><?php echo lang('清空'); ?></a>
            </li>
            <li>
                <a href="javascript:void(0);" class="zj_x zf_num">0</a>
            </li>
            <li>
                <a href="javascript:void(0);" class="zf_del"><?php echo lang('删除'); ?></a>
            </li>
        </ul>
    </div>
    <div class="hbbj"></div>
                        ...
                        success: function (data) {
                            ...
                            if (data.status == 1) {
                                $.each(data.msg, function (key, val) {
                                    ...
                                    str += '<a href="javascirpt:void(0)" onclick="Buyit(this)" data-id =' + val.id + '><?php echo lang("买入"); ?></a>';
                                    str += '</div></div>';
                                    str += '</tr>';
                                });
