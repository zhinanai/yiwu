<?php /*a:2:{s:83:"/www/wwwroot/yiwunqianbaonew/application/mobile/view/transaction/tran_salesell.html";i:1535790612;s:62:"/www/wwwroot/yiwunqianbaonew/application/mobile/view/base.html";i:1535011708;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
	     ...
	     <div class="fabchsding">     	
		      <div class="fill_styaa">      	
		       ...
		       <center>
                   <form> 	
			     	<div class="fill_styaa">	       	
			       	<p><?php echo lang("出售价格"); ?>：</p>
			       	<span class="sdynd"><input  style="width:22.5vmin" type="number" size=40 name="Data"  id="total"   readonly="readonly"  value="" class="" ></span>
					...
					<div class="zsselect_nrr">
				      <div class="zsnr">
			       	...
			       	<div class="fill_styaa">	       	
			       	<p><?php echo lang("出售数量"); ?>：</p>
                    <input type="number" size="40" name="Data2" min='0.0' id="num" onkeyup="enfocus()" class="livalue" value="" onkeyup="value=value.replace(/[^\d]/g,'')"  oninput="checkNum(this)" placeholder="<?php echo lang('请输入数量'); ?>">
			       <!-- 	<input type="number" size=40 name="Data2"  id="num"  class="livalue" value="" onkeyup="value=value.replace(/[^\d]/g,'')" placeholder="请输入数量"> -->
			       	</div>

			       	<div class="fill_styaa">	       	
			       	<p><?php echo lang("支付金额"); ?>：</p>
			       	<input type="number" size="40" name="Copy"  min='0.0'   readonly="readonly" id="copy" class=""> 
			       	</div>
                </form>
                </center>

		      <a  class="dig_zhifuanj ljzf_but" href="javascript:void(0);">
				  <?php echo lang("发布"); ?>
    ...
    <script>
        ...
        $('.xe_pl_a').click(function(){
         ...
         $.ajax({
                            ...
                            type:'post',
                            data:{'num':t2,'tprice':t3,'type':1,'cid':cid},
                            datatype:'json',
               ...
               setTimeout(function(){
                 ...
                 var cid = $('#cid').val();//币的种类
                     ...
                     $.ajax({
                         ...
                         type:'post',
                         data:{'dprice':dprice,'num':num,'tprice':tprice,'cid':cid,'pwd':pwd,'type':1},
                         datatype:'json',
                         success:function (mes) {
                             if(mes.status == 1){
