<?php /*a:2:{s:72:"/www/wwwroot/yiwunqianbaonew/application/admin/view/recharge/wallet.html";i:1535420122;s:61:"/www/wwwroot/yiwunqianbaonew/application/admin/view/base.html";i:1535420122;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<blockquote class="layui-elem-quote news_search">
	<div class="layui-inline">
        <div class="layui-input-inline">
            <input type="text" class="layui-input searchVal" placeholder="请输入搜索的会员id">
        </div>
        <a class="layui-btn search_btn" data-type="reload">搜索</a>
    </div>
    
</blockquote>
<table id="list" lay-filter="userlog" ></table>
...
<script type="text/javascript" src="/static/admin/js/adminwallet.js"></script>
</body>
</html>