<?php /*a:2:{s:69:"/www/wwwroot/yiwunqianbaonew/application/mobile/view/user/mobile.html";i:1535420122;s:62:"/www/wwwroot/yiwunqianbaonew/application/mobile/view/base.html";i:1535011708;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="header">
    ...
    <div class="header_c">
        <h2><?php echo lang('手机号'); ?></h2></div>
    <div class="header_r"></div>
</div>
<div class="big_width100">
    <div class="nic_xiu">
        <input type="text"  value="<?php echo lang('您的手机号'); ?>:<?php echo htmlentities($mobile); ?>" readonly>
    </div>
 </div>
