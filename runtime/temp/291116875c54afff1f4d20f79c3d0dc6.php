<?php /*a:2:{s:67:"/www/wwwroot/yiwunqianbaonew/application/admin/view/role/index.html";i:1535420122;s:61:"/www/wwwroot/yiwunqianbaonew/application/admin/view/base.html";i:1535420122;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body class="childrenBody">
	...
	<table id="list" lay-filter="role" ></table>
	<script type="text/html" id="barDemo">
		{{# if(d.id==1){ }}
		<a class="layui-btn layui-btn-xs" >拥有所有权限</a>
		{{# }else{ }}
		<a class="layui-btn layui-btn-xs " lay-event="edit">分配节点</a>
...
<script type="text/javascript" src="/static/admin/js/rolelist.js"></script>
</body>
</html>