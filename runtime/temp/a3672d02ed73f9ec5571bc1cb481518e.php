<?php /*a:2:{s:81:"/www/wwwroot/yiwunqianbaonew/application/mobile/view/digitalassets/wallet_in.html";i:1535790768;s:62:"/www/wwwroot/yiwunqianbaonew/application/mobile/view/base.html";i:1535011708;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	...
	<div class="header">
	    ...
	    <div class="header_c"><h2><?php echo lang('易宝转入'); ?></h2></div>
	    <div class="header_r"></div>
	</div>
    <div class="big_width100">
         <div class="fill_sty clear_wl">
          <p style="color: #666;"><?php echo lang('当前可用数字资产'); ?>:<span style="margin-left:0.3rem;font-weight: bold;color: #333;"><?php echo htmlentities($myassets['c_nums']); ?></span></p>
    
         </div>
          <div class="fill_sty clear_wl">
          <p><?php echo lang('转入数量'); ?>:</p>
...
<script type="text/javascript">
  ...
  // });
      ...
      if(tjyhk==0){
                layer.msg('<?php echo lang("你当前是使用用户，请最低升级至普通用户"); ?>！');
            return;
      }   
    });
  </script>
