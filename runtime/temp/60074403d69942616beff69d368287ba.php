<?php /*a:2:{s:77:"/www/wwwroot/yiwunqianbaonew/application/mobile/view/growth/introrecords.html";i:1535420122;s:62:"/www/wwwroot/yiwunqianbaonew/application/mobile/view/base.html";i:1535011708;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="header">
        <div class="header_l">
                <a href="<?php echo url('/mobile/Growth/Intro'); ?>"><img src="/static/mobile/images/jiant.png" alt=""></a>
        </div>
        <div class="header_c"><h2><?php echo lang("转入记录"); ?></h2></div>
    ...
    <div class="big_width100">
            ...
            <span style='color:#666;display: block;min-width:2rem;text-align:center;margin:1.5rem auto;'><?php echo lang("暂无转入记录"); ?></span>
            <?php endif; ?>
        </div>
