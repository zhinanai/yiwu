<?php /*a:2:{s:71:"/www/wwwroot/yiwunqianbaonew/application/mobile/view/crowd/crowds2.html";i:1535790610;s:62:"/www/wwwroot/yiwunqianbaonew/application/mobile/view/base.html";i:1535011708;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            	...
            	<ul class="clear_wl">
					...
					<li>
						<a href="<?php echo url('/mobile/Crowd/crowds',array('step'=>2)); ?>">
							...
							<p class="nop"><?php echo lang('已结束'); ?></p>
						</a>
						<div class="nj"></div>
					</li>
	    		</ul>
		   ...
		   <div class="zcweikais">
			   <div class="zcweikais_top clear_wl">
				   ...
				   <div class="zcweikais_topwz">
					   ...
					   <p class="zcxwz"><span><?php echo lang('每个ID限购'); ?><?php echo htmlentities($vo['limit']); ?><?php echo lang('枚'); ?></span><?php echo lang('释放比例'); ?>：100.00%</p>
			   ...
			   <div class="zcweikais_mid clear_wl">
				   <ul>
					   ...
					   <li class="zcweikais_mid_lic"><p><?php echo lang('截止时间'); ?><br/><span class="hse"><?php echo date("Y-m-d",$vo["end_time"]) ?></span></p></li>
				   </ul>
			   </div>
			   <div class="zcweikais_bottom clear_wl">
				   ...
				   <a href="javascript:;" class="zcweikais_bottom_jdzb_a"><?php echo lang('已结束'); ?></a>
